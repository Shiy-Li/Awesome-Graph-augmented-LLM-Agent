...
- AgentKit: Structured LLM Reasoning with Dynamic Graphs (CLM, 2024) 📄 [[paper]](https://arxiv.org/abs/2402.14034) 💻 [[code]](https://github.com/holmeswww/AgentKit)
...
- RATT: A Thought Structure for Coherent and Correct LLM Reasoning (AAAI, 2025) 📄 [[paper]](https://ojs.aaai.org/index.php/AAAI/article/view/34876)
...
- Thought Graph: Generating Thought Process for Biological Reasoning (WWW, 2024) 📄 [[paper]](https://dl.acm.org/doi/abs/10.1145/3589335.3651572) 💻 [[code]](https://github.com/ethan5437/thought-graph-www/)
- Graph of Goal-Oriented Thoughts: Design and Implementation of LLM Agents (SOCIALIZE, 2025) 📄 [[paper]](https://ceur-ws.org/Vol-3957/SOCIALIZE-paper02.pdf) 💻 [[code]](https://github.com/ls-cnr/MIRA)
...
- KG-Agent: An Efficient Autonomous Agent Framework for Complex Reasoning over Knowledge Graph (ACL, 2025) 📄 [[paper]](https://arxiv.org/abs/2402.11163)

### 🛠️ Graphs for Tool Management

#### Tool Graphs for Tool Selection
- ControlLLM: Augment Language Models with Tools by Searching on Graphs (ECCV, 2024) 📄 [[paper]](https://link.springer.com/chapter/10.1007/978-3-031-73254-6_6) 💻 [[code]](https://github.com/OpenGVLab/ControlLLM)
...
- AFlow: Automating Agentic Workflow Generation (ICLR, 2025) 📄 [[paper]](https://arxiv.org/abs/2410.10762) 💻 [[code]](https://github.com/FoundationAgents/AFlow)
- EvoFlow: Evolving Diverse Agentic Workflows On The Fly (arxiv, 2025) 📄 [[paper]](https://arxiv.org/abs/2502.07373) 💻 [[code]](https://github.com/bingreeky/EvoFlow)
...
- Understanding the Information Propagation Effects of Communication Topologies in LLM-based Multi-Agent Systems (EMNLP, 2025) 📄 [[paper]](https://arxiv.org/abs/2505.23352) 💻 [[code]](https://github.com/se7esx/EIB/)
...
- Self-evolving Multi-agent Collaboration Networks for Software Development (ICLR, 2025) 📄 [[paper]](https://arxiv.org/abs/2410.16946) 💻 [[code]](https://yuzhu-cai.github.io/rSDE-Bench/)
- AnyMAC: Cascading Flexible Multi-Agent Collaboration via Next-Agent Prediction (arxiv, 2025) 📄 [[paper]](https://arxiv.org/abs/2506.17784) 💻 [[code]](https://github.com/SongW-SW/AnyMAC)
...
- Improving Multi-Agent Debate with Sparse Communication Topology (Findings of EMNLP, 2024) 📄 [[paper]](https://arxiv.org/abs/2406.11776)
...
- RMoA: Optimizing Mixture-of-Agents through Diversity Maximization and Residual Compensation (arxiv, 2025) 📄 [[paper]](https://arxiv.org/abs/2505.24442) 💻 [[code]](https://github.com/mindhunter01/RMoA)
...
- Goal-Aware Identification and Rectification of Misinformation in Multi-Agent Systems (arxiv, 2025) 📄 [[paper]](https://arxiv.org/abs/2506.00509) 💻 [[code]](https://github.com/zhrli324/ARGUS)
- FlowReasoner: Reinforcing Query-level Meta-agents (arxiv, 2025) 📄 [[paper]](https://arxiv.org/abs/2504.15257) 💻 [[code]](https://github.com/sail-sg/FlowReasoner)
- Agent-SafetyBench: Evaluating the Safety of LLM Agents (arxiv, 2024) 📄 [[paper]](https://arxiv.org/abs/2412.14470) 💻 [[code]](https://github.com/thu-coai/Agent-SafetyBench/)
- AgentAuditor: Human-Level Safety and Security Evaluation for LLM Agents (arxiv, 2025) 📄 [[paper]](https://arxiv.org/abs/2506.00641) 💻 [[code]](https://github.com/Astarojth/AgentAuditor-ASSEBench/)
